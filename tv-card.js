...
const keys = {
    ...
    "volume_up": {"key": "sendevent /dev/input/event4 4 4 786665 && sendevent /dev/input/event4 1 115 1 && sendevent /dev/input/event4 0 0 0 && sendevent /dev/input/event4 4 4 786665 && sendevent /dev/input/event4 1 115 0 && sendevent /dev/input/event4 0 0 0", "icon": "mdi:volume-plus"},
    "volume_down": {"key": "sendevent /dev/input/event4 4 4 786666 && sendevent /dev/input/event4 1 114 1 && sendevent /dev/input/event4 0 0 0 && sendevent /dev/input/event4 4 4 786666 && sendevent /dev/input/event4 1 114 0 && sendevent /dev/input/event4 0 0 0", "icon": "mdi:volume-minus"},
    "volume_mute": {"key": "sendevent /dev/input/event4 4 4 786658 && sendevent /dev/input/event4 1 113 1 && sendevent /dev/input/event4 0 0 0 && sendevent /dev/input/event4 4 4 786658 && sendevent /dev/input/event4 1 113 0 && sendevent /dev/input/event4 0 0 0", "icon": "mdi:volume-mute"},
    "return": {"key": "sendevent /dev/input/event4 4 4 458993 && sendevent /dev/input/event4 1 158 1 && sendevent /dev/input/event4 0 0 0 && sendevent /dev/input/event4 4 4 458993 && sendevent /dev/input/event4 1 158 0 && sendevent /dev/input/event4 0 0 0", "icon": "mdi:arrow-left"},
    "source": {"key": "SOURCE", "icon": "mdi:video-input-hdmi"},
    "info": {"key": "INFO", "icon": "mdi:television-guide"},
    "home": {"key": "sendevent /dev/input/event4 4 4 786979 && sendevent /dev/input/event4 1 172 1 && sendevent /dev/input/event4 0 0 0 && sendevent /dev/input/event4 4 4 786979 && sendevent /dev/input/event4 1 172 0 && sendevent /dev/input/event4 0 0 0", "icon": "mdi:home"},
    ...
    "enter": {"key": "sendevent /dev/input/event4 4 4 458840 && sendevent /dev/input/event4 1 96 1 && sendevent /dev/input/event4 0 0 0 && sendevent /dev/input/event4 4 4 458840 && sendevent /dev/input/event4 1 96 0 && sendevent /dev/input/event4 0 0 0", "icon": "mdi:checkbox-blank-circle"},
    "right": {"key": "RIGHT", "icon": "mdi:chevron-right"},
    "down": {"key": "DOWN", "icon": "mdi:chevron-down"},
    "rewind": {"key": "REWIND", "icon": "mdi:rewind"},
    "play": {"key": "sendevent /dev/input/event4 4 4 786637 && sendevent /dev/input/event4 1 164 1 && sendevent /dev/input/event4 0 0 0 && sendevent /dev/input/event4 4 4 786637 && sendevent /dev/input/event4 1 164 0 && sendevent /dev/input/event4 0 0 0", "icon": "mdi:play"},
    "pause": {"key": "sendevent /dev/input/event4 4 4 786637 && sendevent /dev/input/event4 1 164 1 && sendevent /dev/input/event4 0 0 0 && sendevent /dev/input/event4 4 4 786637 && sendevent /dev/input/event4 1 164 0 && sendevent /dev/input/event4 0 0 0", "icon": "mdi:pause"},
